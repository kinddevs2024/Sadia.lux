...
const Inventory = () => {
  ...
  const handleDelete = (id) => {
    if (
      window.confirm("Вы уверены, что хотите удалить эту запись инвентаря?")
    ) {
  ...
  return (
    <div className="p-8">
      ...
      {showQRGeneratorModal && selectedProductForQR && (
        <QRCodeGenerator
          productId={selectedProductForQR.productId}
          productName={selectedProductForQR.productName}
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4">
        <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">
          {item
            ? "Редактировать запись инвентаря"
...
// Render QR modal outside main component? The component itself will render it when state is set inside component.
